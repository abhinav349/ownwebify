...
export const metadata: Metadata = {
  title: "Web Development Pricing | Affordable Websites from ₹15,000",
  description:
    "Transparent pricing for professional web development. Landing pages from ₹15,000, business websites from ₹30,000, e-commerce from ₹51,000. No hidden fees. Modern tech, fast delivery.",
  openGraph: {
    title: "Web Development Pricing - Affordable Packages",
    description:
      "Professional websites starting at ₹15,000. Transparent pricing, no hidden fees. Landing pages, business sites, e-commerce, and custom web apps.",
